...
preferences {
   ...
   section("After how many minutes later?") {
		input "minutesLater", "number", title: "After minutes..."
	}
}
...
def unlockDoor() {                                                // This process unlocks the door.
               lock1.unlock()                                     
}
...
def presence(evt)
{
	...
	if (anyLocked) {
        ...
        runIn(60*minutesLater, unlockDoor)
